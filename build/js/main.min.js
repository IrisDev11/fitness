...
var _setupVideo = require("./modules/setup-video");
...
var _validateInputPhone = require("./modules/validate-input-phone");
var _initSmothScroll = require("./modules/init-smoth-scroll");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _validateInputPhone.validateInputPhone)();
...
},{"./modules/init-slider-coaches":4,"./modules/init-slider-reviews":5,"./modules/init-smoth-scroll":6,"./modules/setup-video":8,"./modules/tabs/init-tabs":9,"./modules/validate-input-phone":11,"./utils/ios-vh-fix":13}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createsMaskPhone = void 0;
var _imask = _interopRequireDefault(require("imask"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var iMask = _imask.default;
var createsMaskPhone = function createsMaskPhone(phone) {
  iMask(phone, {
    mask: '+7(000)000-00-00'
  });
};
exports.createsMaskPhone = createsMaskPhone;

},{"imask":1}],4:[function(require,module,exports){
"use strict";
...
var initSliderCoaches = function initSliderCoaches() {
  if (document.querySelector('.coaches__slider')) {
    ...
    var swp = new Swiper('.coaches__slider', {
      observer: true,
      slidesPerView: 4,
      loop: true,
      speed: 1e3,
...
var initSliderReviews = function initSliderReviews() {
  if (document.querySelector('.reviews__slider')) {
    // eslint-disable-next-line no-new, no-unused-vars, no-undef
    var swp = new Swiper('.reviews__slider', {
      observer: true,
      slidesPerView: 1,
      slidePerGroup: 1,
      speed: 1e3,
...
},{"./makes-smoth-scroll":7}],7:[function(require,module,exports){
"use strict";
...
var video = document.querySelector('.about-company__video');
var setupVideo = function setupVideo() {
  var imageContainer = video.querySelector('.about-company__video-image');
  var button = video.querySelector('.about-company__video-button');
...
exports.validateInputPhone = void 0;
var _createsMaskPhone = require("./creates-mask-phone");
var feedbackPhone = document.querySelector('#feedback-tel');
var validateInputPhone = function validateInputPhone() {
  (0, _createsMaskPhone.createsMaskPhone)(feedbackPhone);
...
exports.validateInputPhone = validateInputPhone;

},{"./creates-mask-phone":3}],12:[function(require,module,exports){
"use strict";
